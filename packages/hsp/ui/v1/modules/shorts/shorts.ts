...
export const SHORTS: TShort[] = [
  {
    ...
    description:
      'A witty critique of being agile in software development and discovering the Brazilian definition of the current state agile generated called “eXtreme Go Horse” methodology',
  ...
  },
  {
    ...
    description:
      'Why End-to-End Testing is not a end-all silver bullet solution.',
    cover: '/res/shorts/3-e2e/image02.png',
    tags: [TTags.TESTING, TTags.PROCESS],
    source: {
      author: 'Mike Wacker',
  ...
  },
  {
    ...
    cover:
      '/res/shorts/2-cq-stable/media-queries-vs-containe-fa94919e025e3_960.png',
