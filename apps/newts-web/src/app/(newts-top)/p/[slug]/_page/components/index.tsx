  ...
  return (
    <>
      ...
      <article>
        ...
        {/* Post content */}
        <section className="max-w-full min-h-[50vh] rounded-2xl bg-bgprimary-100 dark:bg-bgprimary-800">
          {postCoverUrl && (
            <Image
              src={postCoverUrl}
          ...
          <ReactMarkdown className="p-4 md:px-8 md:py-12 prose prose-black dark:prose-invert max-w-full break-words">
