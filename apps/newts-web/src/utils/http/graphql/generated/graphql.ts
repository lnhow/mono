...
export const useGetParentCategoriesQuery = <
    ...
    useQuery<GetParentCategoriesQuery, TError, TData>(
      ...
      fetcher<GetParentCategoriesQuery, GetParentCategoriesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetParentCategoriesDocument, variables),
      options
    );
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetParentCategories(variables?: GetParentCategoriesQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetParentCategoriesQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetParentCategoriesQuery>(GetParentCategoriesDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetParentCategories', 'query');
    }
  };
}
